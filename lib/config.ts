...
export const COMPONENT_STYLES = {
	...
	hotspotLabel:
		'absolute flex justify-center items-center text-center w-28 h-28 text-white/90 font-bold drop-shadow-2xl z-10 left-6 bottom-12 text-xs leading-none transition-all duration-300 ease-out hover:scale-110 hover:cursor-pointer active:scale-95',
